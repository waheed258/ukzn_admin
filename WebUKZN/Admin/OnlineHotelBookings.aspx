<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="OnlineHotelBookings.aspx.cs" Inherits="Admin_OnlineHotelBookings" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">OnLine Hotel Bookings</li>
            </ol>
        </section>
