...
public partial class SalesAdmin_AgentFlightBooking : System.Web.UI.Page
{
    ...
    private void BindFlightBooking()
    {
        try
        {
            ...
            DataSet objDs = objBAFlightSearch.GetAgentBookingsByDates(Convert.ToInt32(Session["loginId"]), txtStartDate.Text, txtTodate.Text, RoleId, CompanyId);
    ...
    protected void gdvFlights_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "GenerateTicket")
        {
            ...
            Session["returnurl"] = "../Admin/AgentFlightBooking.aspx";
