...
public partial class SalesAdmin_LastDateToTicket : System.Web.UI.Page
{
    ...
    private void BindFlightBooking()
    {
        try
        {
            ...
            DataSet objDs = objBAFlightSearch.GetTrueLastDateToTicketAlerts(CreatedBy, RoleId, CompanyId);
    ...
    protected void gdvFlightBookings_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "GenerateTicket")
        {
            ...
            Session["returnurl"] = "../Admin/LastDateToTicket.aspx";
    ...
    protected void gdvFlightBookings_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (Session["role_id"].ToString() == "1" || Session["role_id"].ToString() == "4")
                {
        ...
        try
        {
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=Eticketneedtodo_" + Session["loginId"].ToString() + ".pdf");
