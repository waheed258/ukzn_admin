...
public partial class SalesAdmin_printhotelInvoice : System.Web.UI.Page
{
    ...
    private void PrintHotelTicket(int RequestId)
    {
        try
        {
            ...
            if (objds.Tables[0].Rows.Count > 0)
            {
                ...
                string Status = objds.Tables[0].Rows[0]["status_desc"].ToString();
                FileNo = objds.Tables[0].Rows[0]["FileNo"].ToString();
                ...
                if (objds.Tables[0].Rows.Count > 0)
                {
                    for (int i = 0; i < objds.Tables[0].Rows.Count; i++)
                    {
                        ...
                        str.Append("<td align='center'  style='width: 190px;font-size:10px;'>" + objds.Tables[0].Rows[0]["Infants"].ToString() + "</td><td align='center'  style='width: 147px;font-size:10px;'>" + Status + "</td> </tr>");
                    }
                }
                str.Append("</table>");
                ...
                //str.Append("<br />");
                //str.Append("<table>");
                //str.Append("<tr><td></td>  <td></td> <td align='left' style='width: 482px;font-weight: bold;font-size:10px;'>Paid Amount :</td><td align='left' style='font-size:10px;'>R " + objds.Tables[0].Rows[0]["Amount"].ToString() + "</td></tr>");
